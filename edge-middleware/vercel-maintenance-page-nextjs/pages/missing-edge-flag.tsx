export default function MissingEdgeFlagDialog() {
  return (
    <div
                ...
                <div className="mt-2">
                  ...
                  <ol className="text-sm text-gray-500 list-disc ml-8 mt-2 flex gap-2 flex-col">
                    <li className="list-item list-disc">
                      ...
                      through the Flargd Admin UI.
                    </li>
                    <li className="list-item list-disc">
                      Go to your Vercel dashboard and add an environment
                      variable named <strong>EDGE_FLAGS_HOST</strong> that
                      points to the Flargd host server.
                    </li>
                    <li className="list-item list-disc">
                      Add another environment variable named{" "}
                      <strong>EDGE_FLAGS_APP</strong> that indicates the Flargd
                      project {"you're"} targetting.
                    </li>
                    <li className="list-item list-disc">
                      Finally, restart or redeploy your Vercel app so that the
                      app can see the new environment variables.
                    </li>
                  </ol>
